...
public class AudioManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (SettingsManager.currentSettings != null)
        {
            ...
            sfxVolume = SettingsManager.currentSettings.soundVolume;
        }
        else
        {
    ...
    void Update()
    {
        ...
        SettingsManager.currentSettings.soundVolume = sfxVolume;
        ...
        targetSFXVolume = SettingsManager.currentSettings.soundVolume*10f - Mathf.Clamp(2 * Camera.main.orthographicSize, 10, 100);
